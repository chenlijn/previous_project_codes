...
INIT_FOLDER="${WORK_DIR}/resume_models/xception"
...
GLAUCOMA_DATASET=/root/mount_out/data/glaucoma_disc_segmentation_sorted_data_full_20180917/tfrecords


# Train 10 iterations.
NUM_ITERATIONS=260900 # number of iterations for 200 epoches and batch_size=8
...
EXPORT_PATH="${EXPORT_DIR}/frozen_disc_seg_inference_graph.pb"
