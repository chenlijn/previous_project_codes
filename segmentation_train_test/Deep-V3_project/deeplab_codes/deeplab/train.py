...
flags.DEFINE_integer('learning_rate_decay_step', 160000,
...
def main(unused_argv):
  ...
  with tf.Graph().as_default() as graph:
    with tf.device(config.inputs_device()):
      ...
      ####test###
      #print type(samples)
      #temp_names = list(sorted(samples.keys()))
      #temp_tensors = list([samples[n] for n in temp_names])
      #print temp_names
      #print temp_tensors
      ##v1, v2, v3, v4, v5 = inputs_queue.dequeue()
      ##print v1
      ##print v2
      ##print v3
      ##print v4
