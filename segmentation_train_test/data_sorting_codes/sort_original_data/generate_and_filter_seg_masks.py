...
if __name__ == "__main__":
    ...
    #data_root = '/mnt/lijian/mount_out/data/glaucoma_20180720/filtered/'
    #data_root = '/root/mount_out/data/original_glaucoma_data/all_data_sorted/disc_2000/disc-800/'
    #data_root = '/root/mount_out/data/glaucoma_disc_segmentation_sorted_data_full_20180917/healthy/'
    data_root = '/root/mount_out/data/original_glaucoma_data/all_data_sorted/healthy/'
    
    #version = 'v1'
    #img_type = 'abnormal'
    #img_path = data_root + '201802_data2label_v1/glaucoma_data2label_v1-bing/' + img_type + '/' #1
    ...
    #generate the masks
    n_type = ''
    img_path = data_root + '/images/' + n_type  # v2
    mask_path = data_root + 'xmls/' + n_type # v2
    new_mask_path = data_root + 'masks/' + n_type # v2
    show_path = data_root + 'show/' + n_type # v2
    ...
    for annot_file in annot_files:
        if annot_file.endswith('.xml'):
            ...
            # show = util.draw_mask(img, gen_mask)
            show = draw_seg_mask_on_img(img, gen_mask)
            save_name = show_path + name + '.png'
    ...
    ## draw masks on images
    ##n_type = 'abnormal'
    ##img_src_dir = data_root + n_type + '/images/' 
    ##mask_src_dir = data_root + n_type + '/masks/' 
    ##test_path = data_root + n_type + '/show_masks/'
    #data_root = '/mnt/lijian/mount_out/data/glaucoma_segmentation_imgs/'
    #img_src_dir = data_root + '/sorted_disc/images/'
    #mask_src_dir = data_root + '/sorted_disc/masks/'
    #test_path = data_root + '/show_masks/'
