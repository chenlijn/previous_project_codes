...
if __name__=="__main__":
    ...
    img_folder = '/root/mount_out/data/glaucoma_cup_seg_train_val_data_20180823/detected_resized_images_test/' 
    mask_folder = '/root/mount_out/data/glaucoma_cup_seg_train_val_data_20180823/detected_resized_masks_test/' 
    dst_folder = '/root/mount_out/data/glaucoma_cup_seg_train_val_data_20180823/show_masks_test/' 
