...
src_dir_parent = "/root/mount_out/data/glaucoma_disc_segmentation_sorted_data_full_20180810/train_val/train/"
dst_dir_parent = "/root/mount_out/data/glaucoma_disc_segmentation_sorted_data_full_20180810/augmented_data/"
...
for folder in folders:
    for img_t in img_types:
        img_src_dir = src_dir_parent + "images"  
        mask_src_dir = src_dir_parent + "masks"
        ...
        for _ in range(iter_num):
            ...
            image_generator = image_datagen.flow_from_directory(img_src_dir, target_size=(tsize, tsize), batch_size=batchsize, 
                                                                save_to_dir=img_dst_dir, save_prefix=saveprefix, seed=1)
            
            mask_generator = mask_datagen.flow_from_directory(mask_src_dir, target_size=(tsize, tsize), batch_size=batchsize, 
                                                                save_to_dir=mask_dst_dir, save_prefix=saveprefix, seed=1)
