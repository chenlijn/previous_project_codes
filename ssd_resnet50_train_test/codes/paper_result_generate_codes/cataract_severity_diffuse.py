...
if __name__ == '__main__':
    ...
    #model for determining the illness
    model_file = workroot + 'resnet-protofiles-master/ResNet50_severity_diffuse_deploy.prototxt'
    ...
    weights = workroot + 'trained_models_dec_2017/resnet_severity_diffuse_iter_40000.caffemodel'
    #meanfile = '/home/gaia/share/cataractData/codes/lmdb/imaging_types_mean.npy'
    meanfile = workroot + 'trained_models_dec_2017/severity_diffuse_mean.npy'
    ...
    recordfile = workroot + 'miscls_severity_diffuse_.txt'
    misclsImgFolder = workroot + '/bad_case/miscl_severity_diffuse'
    ...
    #valfiles = '/mnt/lijian/mount_out/codes/cataract_severity/diffuse/combined_test/small_pupil_diffuse_light_test.txt'
    #valfiles = '/mnt/lijian/mount_out/codes/cataract_severity/diffuse/combined_test/mydriasis_diffuse_light_test.txt'
    valfiles = '/mnt/lijian/mount_out/data/cataract_community_validation_data/txts_labeled/diffuse_severity_test_data.txt'
    #valfiles = '/mnt/lijian/mount_out/codes/cataract_severity/diffuse/combined_test/severity_diffuse_test.txt'
    ...
    classesmap = '/mnt/lijian/mount_out/codes/cataract_severity/diffuse/cataract_severity_name_mapping.txt'
    correctResults = workroot + '/good_case/severity_diffuse'
