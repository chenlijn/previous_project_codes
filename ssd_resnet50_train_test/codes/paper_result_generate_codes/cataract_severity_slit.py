...
if __name__ == '__main__':
    ...
    #model for determining the illness
    model_file = workroot + 'resnet-protofiles-master/ResNet50_severity_slit_deploy.prototxt'
    ...
    weights = workroot + 'trained_models_dec_2017/resnet_severity_slit_iter_40000.caffemodel'
    #meanfile = '/home/gaia/share/cataractData/codes/lmdb/imaging_types_mean.npy'
    meanfile = workroot + 'trained_models_dec_2017/severity_slit_mean.npy'
    ...
    recordfile = workroot + 'miscls_severity_slit.txt'
    misclsImgFolder = workroot + '/bad_case/miscls_severity_slit'
    ...
    valfiles = '/mnt/lijian/mount_out/data/cataract_community_validation_data/txts_labeled/slit_severity_test_data.txt'
    #valfiles = '/mnt/lijian/mount_out/data/cataract_community_validation_data_20180818/severity_val.txt'
    ...
    correctResults = workroot + '/good_case/severity_slit'
