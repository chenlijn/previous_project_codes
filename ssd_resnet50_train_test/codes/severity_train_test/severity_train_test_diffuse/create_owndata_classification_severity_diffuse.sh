...
DATA=/mnt/lijian/mount_out/codes/cataract_severity/diffuse/combined_train_val
TOOLS=/home/gaia/caffe/build/tools
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/severity_diffuse_train_val.txt \
    $EXAMPLE/severity_diffuse_train_val_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/severity_diffuse_val.txt \
    $EXAMPLE/severity_diffuse_val_lmdb
