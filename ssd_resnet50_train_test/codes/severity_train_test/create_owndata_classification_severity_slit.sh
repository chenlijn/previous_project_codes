...
DATA=/mnt/lijian/mount_out/codes/cataract_severity/slit/combined_train_val
TOOLS=/home/gaia/caffe/build/tools
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/severity_slit_train_val.txt \
    $EXAMPLE/severity_slit_train_val_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/severity_slit_val.txt \
    $EXAMPLE/severity_slit_val_lmdb
