...
#label_prob = np.load("mydriasis_diffuse_light_test_label_prob.npy")
#conf_mat = np.load("mydriasis_diffuse_light_test_cm.npy")
#prefix = "illness_mydr_dif_"
#label_names = ["healthy", "ill", "after_surgery"]   
#record_filename = "illness_mydr_dif_intervals.txt"

## illness types, mydriasis slit
#label_prob = np.load("mydriasis_slit_light_test_label_prob.npy")
#conf_mat = np.load("mydriasis_slit_light_test_cm.npy")
#prefix = "illness_mydr_slit_"
#label_names = ["healthy", "ill", "after_surgery"]   
#record_filename = "illness_mydr_slit_intervals.txt"
...
#label_prob = np.load("severity_small_pupil_slit_light_test_label_prob.npy")
#conf_mat = np.load("severity_small_pupil_slit_light_test_cm.npy")
