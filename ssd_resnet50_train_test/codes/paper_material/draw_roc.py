...
#label_prob = np.load("slit_illness_test_data_label_prob.npy")
#conf_mat = np.load("slit_illness_test_data_cm.npy")
...
#label_prob = np.load("severity_diffuse_severity_test_data_label_prob.npy")
#conf_mat = np.load("severity_diffuse_severity_test_data_cm.npy")
#prefix = "severity_smpu_dif_"
#label_names = ["slight", "severe"]   
#record_filename ="severity_smpu_dif_intervals.txt"

# severity, mydriasis diffuse
label_prob = np.load("severity_slit_severity_test_data_label_prob.npy")
conf_mat = np.load("severity_slit_severity_test_data_cm.npy")
