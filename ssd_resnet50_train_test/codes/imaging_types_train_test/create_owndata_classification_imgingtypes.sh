...
#EXAMPLE=/home/gaia/share/cataractData/codes/lmdb_split
#EXAMPLE=/mnt/lijian/mount_out/work/cataract_project/lmdb
#DATA=/home/gaia/share/cataractData/allData
DATA=/mnt/lijian/mount_out/codes/cataract/imaging_types/combined_train_val
TOOLS=/home/gaia/caffe/build/tools
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/imaging_types_train_val.txt \
    $EXAMPLE/imaging_types_train_val_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    "" \
    $DATA/imaging_types_val.txt \
    $EXAMPLE/imaging_types_val_lmdb
