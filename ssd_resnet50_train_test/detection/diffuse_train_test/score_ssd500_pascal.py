...
train_data = current_wd +  "/eye_train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = current_wd + "/eye_test_lmdb"
...
model_name = "VGG_eye_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = current_wd + "/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = current_wd + "/SSD/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = current_wd + "/jobs/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = current_wd + "/results/{}_score".format(job_name)
...
name_size_file = current_wd + "/test_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = current_wd + "/labelmap_eye.prototxt"
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [500, 1000, 2000, 3000, 4000, 5000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 0,
