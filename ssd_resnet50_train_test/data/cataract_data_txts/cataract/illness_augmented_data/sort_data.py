...
if __name__ == "__main__":
    ...
    ##data_type = 'ill'
    #data_path = '/mnt/lijian/mount_out/cataract_augmented_data_dec2/' + data_type
    ...
    #    txt_file_name = sorter.cwd + '/augmented_' + data_type + '_' + folder + '.txt'
    ...
    ###the illness data
    ###src_path = os.getcwd() + '/cleaned_original_data'
    ##src_path = os.getcwd() + '/imaging_types/labeled_data_to_split'
    ##dst_path = os.getcwd() + '/imaging_types/train_val_split'
