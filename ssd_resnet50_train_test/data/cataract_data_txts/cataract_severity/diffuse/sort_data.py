...
if __name__ == "__main__":
    ...
    ##data_type = 'ill'
    data_path = '/mnt/lijian/mount_out/zhongshan_ophthalmology_20171217'
    ...
    for folder in folders:
        ...
        txt_file_name = sorter.cwd + '/original_data/' + folder + '.txt'
    ...
    ##-------------------------------------- 
    #severity data
    src_path = os.getcwd() + '/original_data'
    dst_path = os.getcwd() + '/labeled_data'
    txt_files = os.listdir(src_path)
    name_mapping_txt = os.getcwd() + '/cataract_severity_name_mapping.txt'
    ...
    src_path = os.getcwd() + '/labeled_data'
    dst_path = os.getcwd() + '/train_val'
